...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< arma::rowvec >::type weights(weightsSEXP);
    Rcpp::traits::input_parameter< bool >::type print_rhs(print_rhsSEXP);
    __result = Rcpp::wrap(euler_hat_irbc(exog, endog, cont, exog_innov_integ, betta, theta, gamma, coeffs_cont, n_exog, n_endog, n_cont, n_fwd, rho, n_integ, N, upper, lower, cheby, weights, print_rhs));
    return __result;
END_RCPP
}
// contemp_eqns_irbc
...
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(euler_hat_grid(coeffs, coeffs_cont, X, lags, params, n_exog, n_endog, n_cont, n_fwd, rho, sig_eps, n_integ, N, upper, lower, cheby, exog_innov_mc, quad, n_nodes, model, mono));
    return __result;
END_RCPP
}
...
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(M1_nodes_weights_mat(mu, sigma));
    return __result;
END_RCPP
}
// integrand_ngm_2
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< bool >::type init_flag(init_flagSEXP);
    Rcpp::traits::input_parameter< double >::type init(initSEXP);
    __result = Rcpp::wrap(var1_sim(n_pds, A, sig_eps, init_flag, init));
    return __result;
END_RCPP
}
// endog_update_slow
